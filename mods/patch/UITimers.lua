...
local MOD_SETTINGS = {
	POTION_TIMER_INDICATOR = {
		...
		["widget_type"] = "stepper",
		["text"] = "Potion Timer Indicator",
		["tooltip"] = "Potion Timer Indicator\n" ..
	...
	POTION_TIMER_INDICATOR_POSITION = {
		...
		["widget_type"] = "stepper",
		["text"] = "Potion Timer Indicator Position",
		["tooltip"] = "Potion Timer Indicator Position\n" ..
...
HUDTimers.create_options = function()
	Mods.option_menu:add_group("HUD_timers", "HUD Timers")
 
	Mods.option_menu:add_item("HUD_timers", MOD_SETTINGS.POTION_TIMER_INDICATOR, true)
	Mods.option_menu:add_item("HUD_timers", MOD_SETTINGS.POTION_TIMER_INDICATOR_POSITION, true)
end
